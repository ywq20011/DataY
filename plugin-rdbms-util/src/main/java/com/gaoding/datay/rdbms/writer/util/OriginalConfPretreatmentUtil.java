package com.gaoding.datay.rdbms.writer.util;
...
import com.gaoding.datay.common.util.ListUtil;
import com.gaoding.datay.rdbms.util.ConnectionFactory;
...
import com.gaoding.datay.rdbms.util.JdbcConnectionFactory;
import com.gaoding.datay.rdbms.util.TableExpandUtil;
import com.gaoding.datay.rdbms.writer.Constant;
import com.gaoding.datay.rdbms.writer.Key;
...
//    }
    ...
    public static boolean isOB10(String jdbcUrl) {
        //ob10的处理
        if (jdbcUrl.startsWith(com.gaoding.datay.rdbms.writer.Constant.OB10_SPLIT_STRING)) {
            String[] ss = jdbcUrl.split(com.gaoding.datay.rdbms.writer.Constant.OB10_SPLIT_STRING_PATTERN);
            if (ss.length != 3) {
