package com.gaoding.datay.rdbms.reader.util;
...
import com.gaoding.datay.rdbms.reader.Constant;
import com.gaoding.datay.rdbms.reader.Key;
...
public final class ReaderSplitUtil {
    ...
    public static List<Configuration> doSplit(
        ...
        for (int i = 0, len = conns.size(); i < len; i++) {
            ...
            // 说明是配置的 table 方式
            LOG.info("isTableMode:{}",isTableMode);
            if (isTableMode) {
                ...
                LOG.info("needSplitTable:{},splitPk:{},eachTableShouldSplittedNumber:{}",needSplitTable,splitPk,eachTableShouldSplittedNumber);
                if (needSplitTable) {
                    if (tables.size() == 1) {
                    ...
                    LOG.info("eachTableShouldSplittedNumber:{}",eachTableShouldSplittedNumber);
