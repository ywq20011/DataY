...
import com.gaoding.datay.rdbms.reader.util.OriginalConfPretreatmentUtil;
import com.gaoding.datay.rdbms.reader.util.PreCheckTask;
import com.gaoding.datay.rdbms.reader.util.ReaderSplitUtil;
import com.gaoding.datay.rdbms.reader.util.SingleTableSplitUtil;
import com.gaoding.datay.rdbms.util.DBUtil;
import com.gaoding.datay.rdbms.util.DBUtilErrorCode;
import com.gaoding.datay.rdbms.util.DataBaseType;
import com.gaoding.datay.rdbms.util.RdbmsException;
...
public class CommonRdbmsReader {
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            //ob10的处理
            if (this.jdbcUrl.startsWith(com.gaoding.datay.rdbms.writer.Constant.OB10_SPLIT_STRING) && this.dataBaseType == DataBaseType.MySql) {
                String[] ss = this.jdbcUrl.split(com.gaoding.datay.rdbms.writer.Constant.OB10_SPLIT_STRING_PATTERN);
                if (ss.length != 3) {
