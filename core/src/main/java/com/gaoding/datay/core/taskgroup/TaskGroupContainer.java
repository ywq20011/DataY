package com.gaoding.datay.core.taskgroup;
...
import com.gaoding.datay.common.statistics.PerfRecord;
...
import com.gaoding.datay.core.statistics.container.communicator.taskgroup.StandaloneTGContainerCommunicator;
import com.gaoding.datay.core.statistics.plugin.task.AbstractTaskPluginCollector;
import com.gaoding.datay.core.taskgroup.runner.AbstractRunner;
import com.gaoding.datay.core.taskgroup.runner.ReaderRunner;
import com.gaoding.datay.core.taskgroup.runner.WriterRunner;
import com.gaoding.datay.core.transport.channel.Channel;
import com.gaoding.datay.core.transport.exchanger.BufferedRecordExchanger;
import com.gaoding.datay.core.transport.exchanger.BufferedRecordTransformerExchanger;
import com.gaoding.datay.core.transport.transformer.TransformerExecution;
import com.gaoding.datay.core.util.ClassUtil;
import com.gaoding.datay.core.util.FrameworkErrorCode;
import com.gaoding.datay.core.util.TransformerUtil;
    ...
    public void start() {
        try {
            ...
            long reportIntervalInMillSec = this.configuration
                    .getLong(CoreConstant.DATAX_CORE_CONTAINER_TASKGROUP_REPORTINTERVAL, 10000);
            /**
             * 2分钟汇报一次性能统计
             */
