...
import com.gaoding.datay.core.statistics.plugin.task.util.DirtyRecord;
...
public class JdbcPluginCollector extends AbstractTaskPluginCollector {

    public JdbcPluginCollector(Configuration configuration, Communication communication, PluginType type) {
