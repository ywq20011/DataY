...
public class GroovyTransformer extends Transformer {
    ...
    private String getGroovyRule(String expression, List<String> extraPackagesStrList) {
        ...
        sb.append("import static com.gaoding.datay.core.transport.transformer.GroovyTransformerStaticUtil.*;");
        sb.append("import com.gaoding.datay.common.element.*;");
        sb.append("import com.gaoding.datay.common.exception.DataXException;");
        sb.append("import com.gaoding.datay.transformer.Transformer;");
